...
@section('title', 'شكاوي الأستاذ')
@section('page_title', 'شكاوي ' . $teacher->name)
        ...
        <div class="card-body p-4">
            <div class="table-responsive">
                <table class="table align-middle table-hover">
                    <thead><tr><th>العنوان</th><th>الطالب</th><th>الجلسة</th><th>المقدّم</th><th>الحالة</th><th>التاريخ</th><th>الوصف</th></tr></thead>
                    <tbody>
