...
@section('content')
<div class="mb-3">
    <a href="{{ route('teacher.wallet.index') }}" class="btn btn-secondary">رجوع للرصيد</a>
    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#teacherWalletComplaintModal">
        تسجيل شكوى
    </button>
</div>
...
<div class="student-list-card">
    ...
    <div class="teacher-session-detail-grid mb-4">
        ...
        <div>
            ...
            <div class="fw-semibold">{{ $transaction->student?->name ?? $transaction->session?->student?->name ?? '-' }}</div>
        </div>
        <div>
...
@push('modals')
    <div class="modal fade" id="teacherWalletComplaintModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content teacher-modal-card">
                ...
                <div class="modal-body">
                    <form action="{{ route('teacher.wallet.complaint', $transaction) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                        @csrf
                        <div class="col-12">
