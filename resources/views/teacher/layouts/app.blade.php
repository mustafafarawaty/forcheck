...
<body class="teacher-body" data-theme-scope="teacher" data-app-timezone="{{ config('app.timezone') }}">
    ...
    @if($currentTeacher)
        ...
        >
            <form action="{{ route('teacher.instant.toggle') }}" method="POST" class="teacher-live-toggle-form">
                @csrf
            ...
            <div class="teacher-live-request-card d-none" data-teacher-live-card>
                ...
                <div class="d-flex gap-2">
                    <form method="POST" class="flex-fill" data-live-accept-form>
                        @csrf
    ...
    @if($currentTeacher && ! request()->routeIs('teacher.sessions.room.*'))
        <div
            class="modal fade"
